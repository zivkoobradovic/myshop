        ...
        <div class="container mx-auto px-6 md:px-0">
          <div class="flex items-center justify-center">
            <div class="mr-6">
              ...
              <a href="/products/create" class="no-underline hover:underline text-gray-300 text-sm p-3">Create Product</a>
              <a href="/categories/create" class="no-underline hover:underline text-gray-300 text-sm p-3">Create Category</a>
            </div>
