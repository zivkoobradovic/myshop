        ...
        <div class="container px-5 py-24 mx-auto md:w-3/4">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex mb-4">
                        <span class="flex items-center">
                            <svg fill="currentColor" stroke="currentColor" stroke-linecap="round"
                                stroke-linejoin="round" stroke-width="2" class="w-4 h-4 text-teal-500"
                                viewBox="0 0 24 24">
                                <path
                            ...
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" class="w-4 h-4 text-teal-500" viewBox="0 0 24 24">
                                <path
                                    d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z">
                                </path>
                            </svg>
                    ...
                    <p class="leading-relaxed md:mb-10">{{ $product->long_description }}</p>
                  ...
                  <div class="flex">
                      ...
                      <button
                          class="border-2 border-gray-300 ml-1 bg-teal-500 rounded-full w-6 h-6 focus:outline-none"></button>
                  </div>
